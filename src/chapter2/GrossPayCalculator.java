...
//this is a class declaration. Orange words are reserved words in IntelliJ
//class names are always camel case and start with upper case letter
public class GrossPayCalculator {
    ...
    public static void main(String arg[]){
        ...
        //the data info always goes to the right from equation sign, the data type and var mane is always to the left:
        int hours = scanner.nextInt();

        //2. Get the hourly pay rate
        //2.1 Ask user to input the data
        System.out.println("Please insert the hourly pay rate.");
        //2.2 Here we scan (receive) the user's input as an integer with a decimal (most commonly used is a Double:
        ...
        //A variable is essentially a memory location. Variables can store all sources of data.
